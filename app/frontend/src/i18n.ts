...
const T: Record<Lang, Strings> = {
  EN: {
    ...
    ragTitle:'AI Analyst — Coming in Phase 5',
    ragSub:'Ask natural-language questions grounded in your own pipeline data.',
  ...
  PT: {
    ...
    ragTitle:'Analista IA — Fase 5 em Breve',
    ragSub:'Faça perguntas em linguagem natural baseadas nos seus próprios dados.',
  ...
  ES: {
    ...
    ragTitle:'Analista IA — Fase 5 Próximamente',
    ragSub:'Haz preguntas en lenguaje natural basadas en tus propios datos.',
